...
export default function PaymentsPage() {
  ...
  return (
    <main className="space-y-6" aria-labelledby="payments-title">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 id="payments-title" className="text-3xl font-semibold text-gray-900">
            Payments
          </h1>
